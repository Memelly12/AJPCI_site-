<?php 
 ...
 ini_set('display_errors', 1);
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO ADHERANTS (NOM, PRENOM, DATE_NAISSANCE, LIEU_HABITATION, TELEPHONE, EMAIL, PROFESSION, NIVEAU_ETUDE, CHEMIN_IMAGE, STATUT) VALUES ('$nom', '$prenom', '$date_naissance', '$localisation', '$tel', '$email', '$profession', '$niveau_etude', '$upload', '$select');";
